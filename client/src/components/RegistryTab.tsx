        ...
        <div>
            ...
            <div className="mb-8">
                ...
                {config.registryKeys.length === 0 ? (
                    ...
                    config.registryKeys.map((key: { name: string; path: string }, index: number) => (
            ...
            <div className="mb-8">
                ...
                {config.registryValues.length === 0 ? (
                    ...
                    config.registryValues.map((value: { key: string; type: string; value: string }, index: number) => (
                        <Card key={index} className="mb-4">
                            <CardContent className="pt-4">
                                <div className="flex items-center justify-between mb-4">
            ...
            <div className="mb-8">
                ...
                {config.registryCopyKeys.length === 0 ? (
                    ...
                    config.registryCopyKeys.map((key: { path: string }, index: number) => (
                        <Card key={index} className="mb-4">
                            <CardContent className="pt-4">
                                <div className="flex items-center justify-between mb-4">
