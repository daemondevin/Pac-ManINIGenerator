...
interface FilesTabProps {
    ...
    addArrayItem: (section: 'filesMove' | 'directoriesMove' | 'environment', newItem: any) => void;
    removeArrayItem: (section: 'filesMove' | 'directoriesMove' | 'environment', index: number) => void;
    updateArrayItem: (section: 'filesMove' | 'directoriesMove' | 'environment', index: number, field: string, value: any) => void;
